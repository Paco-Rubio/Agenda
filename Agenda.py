        ...
        try:
            ...
            if result_days_int < 0:
                ...
                if not langconfig == "spanish":
                    ...
                    print(" Eso es hoy!")
            elif result_days_int == 1:
                print()
                if not langconfig == "spanish":
                    print(" That is tomorrow! , " + result_days_str + " day left")
                else:
                    print(" Eso es mañana! , queda " + result_days_str + " día")
            elif result_days_int > 0:
                print()
                if not langconfig == "spanish":
...
def age():
    ...
    if not langconfig == "spanish":
        ...
        rawagedate = input(" ¿Con qué fecha quieres operar? (YYYY-MM-DD) (Nombre)  ")
...
def countlines():
    ...
    if countlines == 0:
        if not langconfig == "spanish":
            ...
            print(" No hay líneas en el documento")
    if countlines == 1:
        if not langconfig == "spanish":
            print(" There is " + str(countlines) + " line in the file")
        else:
            print(" Hay " + str(countlines) + " línea en el documento")
    else:
        if not langconfig == "spanish":
